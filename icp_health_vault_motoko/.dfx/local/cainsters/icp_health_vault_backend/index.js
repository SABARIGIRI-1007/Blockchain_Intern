...
import { idlFactory } from './icp_health_vault_backend.did.js';
export { idlFactory } from './icp_health_vault_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_ICP_HEALTH_VAULT_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./icp_health_vault_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the icp_health_vault_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./icp_health_vault_backend.did.js")._SERVICE>}
 */
export const icp_health_vault_backend = createActor(canisterId);
